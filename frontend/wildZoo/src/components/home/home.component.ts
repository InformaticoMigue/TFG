...
@Component({
    ...
    imports: [ShotsComponent, NavbarComponent, HeaderHomeComponent]
})
export class HomeComponent implements OnInit {
    ...
    private getGalleryAnimals():GalleryAnimal[]{
        return [
            ...
            {class: 'Mamífero', cols: 2, rows:2, name: 'Leon', image: '../assets/img/gallery-home/leon-shot.jpg'},
            {class: 'Aves', cols: 1, rows:2, name: 'Loro', image: '../assets/img/gallery-home/ave-shot.jpg'},
